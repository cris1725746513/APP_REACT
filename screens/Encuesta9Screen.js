...
const Preguntas = [
  '1. ¿En mi trabajo estoy libre de conductas sexuales que afecten mi integridad física, psicológica y moral?',
  '2. ¿Mi trabajo está libre de acoso sexual?',
];

const Encuesta9Screen = ({ navigation }) => {
  ...
  const guardar = () => {
    ...
    SyncStorage.set('A9', total);
    navigation.replace('Encuesta10Screen');
    }else{
...
export default Encuesta9Screen;
