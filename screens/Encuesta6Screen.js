...
const Preguntas = [
  '1. ¿En mi trabajo percibo un sentimiento de compañerismo y bienestar con mis colegas?',
  '2. ¿En mi trabajo se brinda el apoyo necesario a los trabajadores sustitutos o trabajadores con algún grado de discapacidad y enfermedad?',
];

const Encuesta6Screen = ({ navigation }) => {
  ...
  const guardar = () => {
    ...
    SyncStorage.set('A6', total);
    navigation.replace('Encuesta7Screen');
    }else{
...
export default Encuesta6Screen;
