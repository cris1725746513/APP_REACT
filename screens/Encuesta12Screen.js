...
const Preguntas = [
  '1. ¿Siento que mis problemas familiares o personales no influyen en el desempeño de las actividades en el trabajo?',
  '2. ¿En mi trabajo se me permite solucionar mis problemas familiares y personales?',
];

const Encuesta12Screen = ({ navigation }) => {
  ...
  const guardar = () => {
    ...
    SyncStorage.set('A12', total);
    navigation.replace('Encuesta13Screen');
    }else{
...
export default Encuesta12Screen;
