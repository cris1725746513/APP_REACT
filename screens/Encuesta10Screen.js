...
const Preguntas = [
  '1. ¿Las directrices y metas que me autoimpongo, las cumplo dentro de mi jornada y horario de trabajo?',
  '2. ¿Tengo un equilibrio y separo bien el trabajo de mi vida personal?',
];

const Encuesta10Screen = ({ navigation }) => {
  ...
  const guardar = () => {
    ...
    SyncStorage.set('A10', total);
    navigation.replace('Encuesta11Screen');
    }else{
...
export default Encuesta10Screen;
