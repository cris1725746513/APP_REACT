...
const Preguntas = [
  '1. ¿Mi jefe inmediato está dispuesto a escuchar propuestas de cambio e iniciativas de trabajo?',
  '2. ¿En mi trabajo se evalúa objetiva y periódicamente las actividades que realizo?',
];

const Encuesta2Screen = ({ navigation }) => {
  ...
  const guardar = () => {
    ...
    SyncStorage.set('A2', total);
    navigation.replace('Encuesta3Screen');
    }else{
