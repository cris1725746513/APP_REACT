...
const Preguntas = [
  '1. ¿Las metas y objetivos en mi trabajo son claros y alcanzables?',
  '2. ¿Siempre dispongo de tareas y actividades a realizar en mi jornada y lugar de trabajo?',
];

const Encuesta4Screen = ({ navigation }) => {
  ...
  const guardar = () => {
    ...
    SyncStorage.set('A4', total);
    navigation.replace('Encuesta5Screen');
    }else{
...
export default Encuesta4Screen;
