...
const Preguntas = [
  '1. ¿Los espacios y ambientes físicos en mi trabajo brindan las facilidades para el acceso de las personas con discapacidad?',
  '2. ¿Las instalaciones, ambientes, equipos, maquinaria y herramientas que utilizo para realizar el trabajo son las adecuadas para no sufrir accidentes de trabajo y enfermedades profesionales?',
];

const Encuesta11Screen = ({ navigation }) => {
  ...
  const guardar = () => {
    ...
    SyncStorage.set('A11', total);
    navigation.replace('Encuesta12Screen');
    }else{
...
export default Encuesta11Screen;
