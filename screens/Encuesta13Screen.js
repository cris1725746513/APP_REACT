...
const Preguntas = [
  '1. ¿En mi trabajo me siento aceptado y valorado?',
  '2. ¿Mi trabajo y los aportes que realizo son valorados y me generan motivación?',
];

const Encuesta13Screen = ({ navigation }) => {
  ...
  const guardar = () => {
    ...
    SyncStorage.set('A13', total);
    navigation.replace('Encuesta14Screen');
    }else{
...
export default Encuesta13Screen;
