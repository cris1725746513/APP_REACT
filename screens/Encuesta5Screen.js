...
const Preguntas = [
  '1. ¿En mi trabajo tengo tiempo para dedicarme a reflexionar sobre mi desempeño en el trabajo?',
  '2. ¿Tengo un horario y jornada de trabajo que se ajusta a mis expectativas y exigencias laborales?',
];

const Encuesta5Screen = ({ navigation }) => {
  ...
  const guardar = () => {
    ...
    SyncStorage.set('A5', total);
    navigation.replace('Encuesta6Screen');
    }else{
...
export default Encuesta5Screen;
