...
const Preguntas = [
  '1. ¿Tengo un trabajo donde los hombres y mujeres tienen las mismas oportunidades?',
  '2. ¿En mi trabajo se respeta mi ideología, opinión política, religiosa, nacionalidad y orientación sexual?',
];

const Encuesta7Screen = ({ navigation }) => {
  ...
  const guardar = () => {
    ...
    SyncStorage.set('A7', total);
    navigation.replace('Encuesta8Screen');
    }else{
...
export default Encuesta7Screen;
