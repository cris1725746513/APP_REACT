...
const Preguntas = [
  '1. ¿Considero que el trabajo que realizo no me causa efectos negativos a mi salud física y mental?',
  '2. ¿Considero que me encuentro física y mentalmente saludable?',
];

const Encuesta14Screen = ({ navigation }) => {
...
export default Encuesta14Screen;
