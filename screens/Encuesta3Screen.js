...
const Preguntas = [
  '1. ¿Mi jefe inmediato interviene, brinda apoyo, soporte y se preocupa cuando tengo demasiado trabajo que realizar?',
  '2. ¿Mi jefe inmediato me brinda suficientes lineamientos y retroalimentación para el desempeño de mi trabajo?',
];

const Encuesta3Screen = ({ navigation }) => {
  ...
  const guardar = () => {
    ...
    SyncStorage.set('A3', total);
    navigation.replace('Encuesta4Screen');
    }else{
...
export default Encuesta3Screen;
